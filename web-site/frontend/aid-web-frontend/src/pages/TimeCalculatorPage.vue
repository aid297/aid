<template>
    <div class="q-pa-md q-gutter-md">
        <q-card flat square bordered class="q-mb-md">
            <q-card-section>
                <div class="text-h4 text-deep-orange">时间计算器</div>
            </q-card-section>
                                ...
                                <q-list>
                                    <q-item clickable>
                                        ...
                                        <q-item-section avatar>
                                            <q-btn square @click="clearOriginalDates" round color="red" icon="fa fa-times"></q-btn>
                                        </q-item-section>

                                        <q-item-section avatar>
                                            <q-btn square icon="event" round color="primary">
                                                <q-popup-proxy @before-show="originalDates_updateProxy" cover transition-show="scale" transition-hide="scale">
                                                    <q-date v-model="originalDatesProxy" flat bordered today-btn landscape years-in-month-view mark="YYYY-MM-DD">
                                                        <div class="row items-center justify-end q-gutter-sm">
                                                            <q-btn square label="Cancel" color="primary" flat v-close-popup />
                                                            <q-btn square label="OK" color="primary" flat @click="originalDates_save" v-close-popup />
                                                        </div>
                                                    </q-date>
                                                </q-popup-proxy>
                                            </q-btn>
                            ...
                            <q-card-section>
                                <q-list>
                                    <q-item clickable>
                                        ...
                                        <q-item-section avatar>
                                            <q-btn square @click="clearFinishedDates" round color="red" icon="fa fa-times"></q-btn>
                                        </q-item-section>

                                        <q-item-section avatar>
                                            <q-btn square icon="event" round color="primary">
                                                <q-popup-proxy @before-show="finishedDates_updateProxy" cover transition-show="scale" transition-hide="scale">
                                                    <q-date v-model="finishedDatesProxy" flat bordered today-btn landscape years-in-month-view mark="YYYY-MM-DD">
                                                        <div class="row items-center justify-end q-gutter-sm">
                                                            <q-btn square label="Cancel" color="primary" flat v-close-popup />
                                                            <q-btn square label="OK" color="primary" flat @click="finishedDates_save" v-close-popup />
                                                        </div>
                                                    </q-date>
                                                </q-popup-proxy>
                                            </q-btn>
