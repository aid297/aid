...
type (
	Attributer[T any] interface{ Register(anyArray AnySlicer[T]) }
...
func (my AttrList[T]) Register(anyArray AnySlicer[T]) { anyArray.SetData(my.list) }

func Items[T any](items ...T) Attributer[T]            { return AttrItems[T]{items: items} }
func (my AttrItems[T]) Register(anyArray AnySlicer[T]) { anyArray.SetData(my.items) }

func Len[T any](length int) Attributer[T]            { return AttrLen[T]{length: length} }
func (my AttrLen[T]) Register(anyArray AnySlicer[T]) { anyArray.SetData(make([]T, my.length)) }

func Cap[T any](cap int) Attributer[T]               { return AttrCap[T]{cap: cap} }
func (my AttrCap[T]) Register(anyArray AnySlicer[T]) { anyArray.SetData(make([]T, 0, my.cap)) }

func Empty[T any]() Attributer[T]                      { return AttrEmpty[T]{} }
func (my AttrEmpty[T]) Register(anyArray AnySlicer[T]) { anyArray.SetData(make([]T, 0)) }
