...
// SetAttrs 设置属性
func (my *AES) SetAttrs(attrs ...secrets.SymmetricAttr) (err error) {
	for idx := range attrs {
...
func (my *AES) encryptCBCFile(plainFile, outFile string, asymmetric secrets.Asymmetric) error {
	var (
		err               error
		plainData         []byte
		fileCipher        []byte
...
func (my *AES) decryptCBCFile(cipherFile, outFile string, asymmetric secrets.Asymmetric) error {
	var (
		err                error
		data               []byte
		keyLen             int
...
func (my *AES) encryptCBCLargeFile(plainFile, outFile string, asymmetric secrets.Asymmetric) error {
	var (
		err               error
		inF, outF         *os.File
		aesKeyAndIV       []byte
...
func (my *AES) decryptCBCLargeFile(cipherFile, outFile string, asymmetric secrets.Asymmetric) error {
	var (
		err                error
		inF, outF          *os.File
...
func (my *AES) encryptECBFile(plainFile, outFile string, asymm secrets.Asymmetric) error {
	var (
		err               error
		plainData         []byte
		fileCipher        []byte
...
func (my *AES) decryptECBFile(cipherFile, outFile string, asymm secrets.Asymmetric) error {
	var (
		err                error
		data               []byte
		keyLen             int
...
func (my *AES) encryptECBLargeFile(plainFile, outFile string, asymmetric secrets.Asymmetric) error {
	var (
		err               error
		inF, outF         *os.File
		encryptedKeyStr   string
...
func (my *AES) decryptECBLargeFile(cipherFile, outFile string, asymmetric secrets.Asymmetric) error {
	var (
		err                error
		inF, outF          *os.File
		keyLenBuf          = make([]byte, 2)
