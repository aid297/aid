...
type (
	MSSQLPool interface {
		...
		SetSources(sources map[string]*gormPools.MSSQLEndpoint)
		SetReplicas(replicas map[string]*gormPools.MSSQLEndpoint)
		GetConn() *gorm.DB
		getRws() *gorm.DB
		Close() error
	}
	...
	MSSQLPoolImpl struct {
		...
		mainConn     *gorm.DB
		sources      map[string]*gormPools.MSSQLEndpoint
		replicas     map[string]*gormPools.MSSQLEndpoint
	}
)
...
func (my *MSSQLPoolImpl) SetSources(sources map[string]*gormPools.MSSQLEndpoint) {
	my.sources = sources
}
func (my *MSSQLPoolImpl) SetReplicas(replicas map[string]*gormPools.MSSQLEndpoint) {
