...
import (
	...
	"github.com/aid297/aid/secret/asymmetric/sm2"
	"github.com/aid297/aid/secret/symmetric/sm4"
)
...
func Test2() {
	...
	if sem, err = sm2.NewSem(sm2.PriKeyBase64("MIGTAgEAMBMGByqGSM49AgEGCCqBHM9VAYItBHkwdwIBAQQgg8EFkfmMQ3vZ8KSSRBPHsXjtiGTtqwf71PD/X1o27uSgCgYIKoEcz1UBgi2hRANCAAQnJBNSZyVLQB6w09WMr320bXK9rbOzdZIb+WM4p2X+3axiI8SpYxIHkMGISmxVs74Wp22nNp9Zi8WKLSPrfInd")); err != nil {
		log.Fatalf("生成种子失败：%v", err)
	}
	...
	if pubKeyBase64 != "MFkwEwYHKoZIzj0CAQYIKoEcz1UBgi0DQgAEJyQTUmclS0AesNPVjK99tG1yva2zs3WSG/ljOKdl/t2sYiPEqWMSB5DBiEpsVbO+FqdtpzafWYvFii0j63yJ3Q==" {
		log.Fatal("公钥错误")
	}
