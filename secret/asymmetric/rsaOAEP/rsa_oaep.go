// Package rsaoaep 提供基于 RSA-OAEP（SHA-256 + MGF1-SHA-256）的非对称加解密，并实现 secret.Asymmetric。
//
// 密钥种子与 secret/asymmetric/rsa 相同，可直接使用本包的 NewSem，或传入 rsa.NewSem 得到的 Semen。
//
...
import (
	...
	myrsa "github.com/aid297/aid/v2/secret/asymmetric/rsa"
)

var _ secret.Asymmetric = (*RSAOAEP)(nil)

// RSAOAEP 使用 RSA-OAEP-SHA256 做加解密；签名为 RSA-PKCS1v15 + SHA-256。
type RSAOAEP struct{ sem secret.Semen }
...
func New(sem secret.Semen) secret.Asymmetric { return &RSAOAEP{sem: sem} }
