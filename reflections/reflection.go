...
func (*Reflection) New(object any, attrs ...Attributer) *Reflection { return New(object, attrs...) }
func (*Reflection) NewByValue(refValue reflect.Value, attrs ...Attributer) *Reflection {
...
func New(object any, attrs ...Attributer) *Reflection {
	var (
...
func NewByReflectValue(refValue reflect.Value, attrs ...Attributer) *Reflection {
	return New(refValue.Interface())
}

func (my *Reflection) Set(attrs ...Attributer) *Reflection {
	if len(attrs) > 0 {
		for idx := range attrs {
...
func (my *Reflection) GetReflectionType() ReflectionType {
	...
	if ref.Kind() != reflect.Ptr {
		...
		case reflect.Int:
			return operations.NewTernary(operations.TrueValue(Int64), operations.FalseValue(Int32)).GetByValue(is64)
		case reflect.Int8:
			return Int8
		case reflect.Int16:
			return Int16
		...
		case reflect.Int64:
			return Int64
		case reflect.Uint:
			return operations.NewTernary(operations.TrueValue(Uint64), operations.FalseValue(Uint32)).GetByValue(is64)
		case reflect.Uint8:
			return Uint8
		case reflect.Uint16:
			return Uint16
	...
	if tagField != "" {
		return anySlices.New(anySlices.List(strings.Split(tagValue, ";"))).
			Every(func(s string) string {
				...
				return operations.NewTernary(operations.TrueFn(t.Last)).GetByValue(t.First() == tagField)
			}).
			In(target)
	} else {
