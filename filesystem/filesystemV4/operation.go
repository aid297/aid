...
func (AttrDirFlag) Set(flag int) DirOperationAttributer { return AttrDirFlag{flag: flag} }
func (my AttrDirFlag) Register(o *DirOperation)         { o.DirFlag = my.flag }

func (AttrDirMode) Set(mode os.FileMode) DirOperationAttributer { return AttrDirMode{mode: mode} }
...
func (*FileOperation) New(attrs ...FileOperationAttributer) *FileOperation {
	return (&FileOperation{FileFlag: DefaultCreateMode, FileMode: 0777}).SetAttrs(attrs...)
}
...
func (AttrFileFlag) Set(flag int) AttrFileFlag    { return AttrFileFlag{flag: flag} }
func (my AttrFileFlag) Register(o *FileOperation) { o.FileFlag = my.flag }

func (AttrFileMode) Set(mode os.FileMode) AttrFileMode { return AttrFileMode{mode: mode} }
