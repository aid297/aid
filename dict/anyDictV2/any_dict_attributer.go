...
type (
	Attributer[K comparable, V any] interface {
		Register(anyDict *AnyDict[K, V])
	}
...
func (my AttrMap[K, V]) Register(anyDict *AnyDict[K, V]) {
...
func (my AttrCap[K, V]) Register(anyDict *AnyDict[K, V]) {
